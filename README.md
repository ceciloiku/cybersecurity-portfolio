...
- [P04 — Sysmon EVTX Investigation Practice](case-investigations/mini-investigations/p04-sysmon-evtx-investigation-practice/)

## Home labs
- [Lab 02 — Sysmon vs Windows Event Logs](home-labs/labs-02-sysmon-vs-winevent-logs/)
- [Lab 04 — Splunk Alert (Sysmon Network Connection)](home-labs/labs-04-splunk-alert-sysmon/)
...
- P02 — Backdoor User + Encoded PowerShell C2 (Splunk)
- P03 — HR Host Triage: Schtasks + Certutil (Splunk)
- P04 — Sysmon EVTX Investigation Practice
- P05 — Windows EVTX Log Triage Practice
